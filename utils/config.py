...
# PGM model options
__C.PGM = edict()
__C.PGM.FEATURE_NODE_CHANNEL = 512  #节点的特征通道
...
def get_output_dir(model, dataset, taskname):
    """
    ...
    """
    outp_path = os.path.join('output', '{}_{}_{}'.format(model, dataset, taskname))
    return outp_path
